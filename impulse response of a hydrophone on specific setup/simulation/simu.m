...
%Nsurf{ii,jj}  = [er.eigenrays(hydn).eigenray(1:er.eigenrays(hydn).nEigenrays).nSurRefl];
%Nbott{ii,jj}   = [er.eigenrays(hydn).eigenray(1:er.eigenrays(hydn).nEigenrays).nBotRefl];
